...
$router->addRoute('login', '/login/', '\tweeterapp\control\TweeterController', 'viewLogin', \tweeterapp\auth\TweeterAuthentification::ACCESS_LEVEL_NONE);
$router->addRoute('post', '/post/', '\tweeterapp\control\TweeterController', 'viewPostTweet', \tweeterapp\auth\TweeterAuthentification::ACCESS_LEVEL_NONE);
